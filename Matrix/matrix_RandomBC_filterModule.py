...
def filterBy_randomBC_EditDistance(any_df, inside_ShS=True, ED_rule=3):
    ...
    ### ACTUAL VERSION ###
    ## How it works:
    ## Grouping is performed only by ['barcode', 'genomic_coordinates']; further ShS groupby is performed performed by funcions
...
if __name__ == "__main__":
    ...
    data_files_name_filter = ".shearsites.ISfixed.LENGTHfixed.randomBC.tsv"
